...
public class User_DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__driver);
        RecyclerView  r_view1 = findViewById(R.id.recycler_view);
        auth= FirebaseAuth.getInstance();
        list=new ArrayList<>();

        W_ilst1=new User_Driver_Adapter(User_DriverActivity.this,list);
        ...
        f_store.collection("User").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                if (!queryDocumentSnapshots.isEmpty())
                {
                    ...
                    for (DocumentSnapshot d:D_list) {
                        ...
                        r_view1.setLayoutManager(new LinearLayoutManager(User_DriverActivity.this));
                        
                    }
                    Toast.makeText(User_DriverActivity.this, "Data set...", Toast.LENGTH_SHORT).show();

                }
                else {
                    Toast.makeText(User_DriverActivity.this, "Data not found", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(User_DriverActivity.this,e.getMessage(), Toast.LENGTH_SHORT).show();
